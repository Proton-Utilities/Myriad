...
## Why use this over the roblox interface

the `InputCapture` library gives you an easy way for keybinding, sinking inputs, capturing non-standard inputs, and more.
